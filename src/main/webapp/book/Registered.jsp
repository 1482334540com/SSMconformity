...
<head>
    ...
    <style>
        /*注册背景*/
        body{
            background-image: url("book/img/registered.jpg") ;
...
<div class="container-fluid">
    ...
    <div class="row  screen">
        <div class="col-lg-4 col-lg-offset-4  col-sm-8  col-sm-offset-2  form ">
          ...
          <form class="form-inline " role="form" action="user/register.do"   method="post">

              <input type="hidden" name="action" value="register">
                <div id="" class="form-group ">
                    <div class="registered-box">
                        <h2 class="registered">欢迎注册</h2>
                        <span>已有账号？<a href="book/Login.jsp">登录</a></span>
                        <span style="margin-left: 8px" class="msg text-danger">${requestScope.message}</span>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="input-box">
                            ...
                            <button type="button" class="btn btn-default glyphicon glyphicon-exclamation-sign btn-i" data-container="body"
                                    ...
                                    data-content="长度为8~14个字符字母/数字以及标点符号至少包含2种不允许有空格、中文" style="position: relative;top: 15px;">
                            </button>
                        </div>
                    ...
                    <div class="form-group">
                        <div class="input-box">
                            ...
                            <img src="kaptcha.jpg" id="validation" style="margin-top: 22px" width="75px" height="35px" alt="">
              ...
              <div class="condition-filter text-center">
                  ...
                  <a href="https://passport.baidu.com/static/passpc-account/html/protocal.html">&lt;&lt;IT用户协议&gt;&gt;</a>
                  <a class="btn btn-success pull-right" role="button" href="book/index.do">返回首页</a>
              </div>
            </form>
    ...
    $(function() {
        ...
        $("#username").blur(function () {
            if(this.value!=""){
                ...
                $.post("user/ajaxVerifyUsername.do",{username:username},function (data) {
                    if (data == "true") {
                         $(".msg").text("用户名可用");
                     } else {
        ...
        $("#code_img").click(function () {
            ...
            $("#validation").prop("src","kaptcha.jpg?data=" + new Date())
