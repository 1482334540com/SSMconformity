            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body .box" id="input-content">
                        ...
                        <form action="book/addBook.do" method="post">
    ...
    $(function () {
        ...
        $(".del").click(function () {
            ...
            if (confirm("确认删除?")){
                ...
                //通过ajax post请求 删除id
                $.post("book/deleteBook.do",{id:id},function (data) {
                    location.href="book/queryAllBook.do";
                })
            }
        })
        ...
        $("#search").focusout(function () {
            ...
            window.location.href="book/likeBook.do?name="+input_val;
        })
